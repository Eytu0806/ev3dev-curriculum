...
Authors: David Fisher and Denny Colomes.
...
def main():
    ...
    my_name = "Denny"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Hunter"  # Used to set the topic that you will *publish to*
